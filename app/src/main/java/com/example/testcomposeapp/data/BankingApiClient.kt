...
import com.example.testcomposeapp.BuildConfig
import com.example.testcomposeapp.data.source.mock.MockDataSource
import com.example.testcomposeapp.data.source.remote.ApiTokenInterceptor
...
object BankingApiClient {
    ...
    internal fun createMock(): MobileBankingApi {
        ...
        val delegate: BehaviorDelegate<MobileBankingApi> =
            mockRetrofit.create(MobileBankingApi::class.java)
